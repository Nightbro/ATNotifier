...
public sealed class SharePointListCheckSettings { public required string SiteUrl { get; init; } public required string ListTitle { get; init; } public string DateField { get; init; } = "Date"; public DayRange Day { get; init; } = DayRange.Today; public SharePointAuthentication Authentication { get; init; } = new(); }
